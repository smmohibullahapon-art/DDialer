...
export default function ResellerPage() {
  ...
  const faqs = [
    {
      q: "What is a White-Label Telecom Reseller Program?",
      a: "DDialer's White-Label Reseller Program allows you to sell cloud PBX, VoIP, virtual numbers, and SMS services under your own brand identity, custom domain, and logo, while leveraging Dial Dynamic Ltd's sovereign infrastructure."
    },
    {
      q: "Can I manage sub-resellers and tiered customer networks?",
      a: "Yes! Our multi-tier reseller architecture enables you to create independent sub-tenants, assign custom credit limits, set individual rate decks, and monitor financial margins."
    },
    {
      q: "Do my clients see any 'DDialer' branding?",
      a: "No. The entire customer portal, invoices, softphone interfaces, and API documentation are fully white-labeled to reflect your company's brand."
    },
    {
      q: "How are reseller profits and billing managed?",
      a: "You purchase wholesale telecom minutes and DIDs at tier-1 rates and set your own retail prices. All prepaid balance deductions and CDR ledgers update automatically in real-time."
    }
  ];
    ...
    <div className="min-h-screen bg-[#070913] text-[#8a99ad] selection:bg-[#00d2ff]/30 selection:text-white font-sans overflow-x-hidden relative">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-[#070913]/85 backdrop-blur-2xl border-b border-white/10 px-6 lg:px-16 h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8 text-xs font-mono">
          ...
          <Link href="/reseller" className="text-white font-bold transition">Reseller Program</Link>
      ...
      <section className="relative pt-44 pb-28 px-6 lg:px-16 max-w-7xl mx-auto flex flex-col items-center text-center space-y-8">
        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-[#00ff88] shadow-inner backdrop-blur-md">
          ...
          <span>White-Label Telecom Reseller &amp; Multi-Tier OS</span>
        </div>

        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight max-w-5xl leading-tight">
          Build Your Own <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d2ff] to-[#00ff88]">Telecom Brand</span>
        </h1>

        <p className="text-sm sm:text-base text-[#8a99ad] max-w-2xl leading-relaxed">
          Launch an independent cloud communication empire. Offer white-labeled VoIP, virtual DIDs, and cloud PBX under your own company name, domain, and rate decks with Dial Dynamic Ltd's sovereign infrastructure.
        </p>
      ...
      {/* 3. Reseller Ecosystem Architecture */}
      <section className="py-24 border-t border-white/10 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="text-xs font-mono px-3 py-1 rounded bg-[#00d2ff]/10 text-[#00d2ff] border border-[#00d2ff]/30">White-Label OS</span>
            <h2 className="text-3xl font-bold text-white">Complete Control Over Your Reseller Hierarchy</h2>
            <p className="text-xs sm:text-sm text-[#8a99ad] leading-relaxed">
              DDialer is built from the ground up to support multi-level white-label reseller networks. Create sub-resellers, assign distinct billing ledgers, and maintain complete anonymity from upstream carrier layers.
            </p>
            <div className="space-y-3 font-mono text-xs">
              <div className="flex items-center gap-3 text-white">
                <Check className="w-4 h-4 text-[#00ff88]" />
                <span>Custom domain and branded tenant control panels</span>
              </div>
              <div className="flex items-center gap-3 text-white">
                <Check className="w-4 h-4 text-[#00ff88]" />
                <span>Multi-level sub-reseller creation and credit allocation</span>
              </div>
              <div className="flex items-center gap-3 text-white">
                <Check className="w-4 h-4 text-[#00ff88]" />
                <span>Custom rate decks and automated margin calculations</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-[#0b0f19] border border-white/15 space-y-6 shadow-2xl font-mono text-xs">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <span className="text-white font-bold">Reseller Network Hierarchy</span>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
                <span className="text-[10px] text-[#8a99ad]">Master Reseller Account</span>
                <div className="text-white font-bold text-sm">Your Brand Communications Ltd</div>
              </div>
              <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
                <span className="text-[10px] text-[#8a99ad]">Active Sub-Tenants / Clients</span>
                <div className="text-[#00d2ff] font-bold text-sm">142 Sub-Accounts Managed</div>
              </div>
              <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-1">
                <span className="text-[10px] text-[#8a99ad]">Monthly Net Profit Margin</span>
                <div className="text-[#00ff88] font-bold text-sm">34.8% Average Margin Return</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-28 px-6 lg:px-16 max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Reseller Platform Features</h2>
          <p className="text-xs sm:text-sm text-[#8a99ad] font-mono">Everything required to operate an independent, highly profitable cloud telecom business.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { icon: Globe, title: 'Custom Domain Branding', desc: 'Host your tenant portal on your own domain (e.g., portal.yourbrand.com) with SSL support.' },
            { icon: Users, title: 'Multi-Tier Sub-Accounts', desc: 'Build an extensive dealer network by provisioning sub-resellers with custom privileges and limits.' },
            { icon: Layers, title: 'Flexible Rate Decks', desc: 'Configure per-minute retail rates, billing increments, and connection fees per client.' },
            { icon: Database, title: 'Automated Billing Ledger', desc: 'Real-time prepaid balance tracking, invoice generation, and automated low-balance alerts.' },
            { icon: ShieldCheck, title: 'Zero Third-Party Branding', desc: 'Completely invisible upstream carrier footprint with 100% white-labeled user interfaces.' },
            { icon: Server, title: 'Dedicated SBC Backing', desc: 'Powered by Kamailio and FreeSWITCH infrastructure maintained 24/7 by Dial Dynamic Ltd.' }
          ].map((item, idx) => {
      ...
      <section className="py-24 border-t border-white/10 bg-white/[0.01]">
        <div className="max-w-4xl mx-auto px-6 lg:px-16 space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl font-bold text-white">Reseller Program Frequently Asked Questions</h2>
            <p className="text-xs text-[#8a99ad] font-mono">Everything you need to know about starting your white-label telecom business with DDialer.</p>
          </div>
